...
{
    GLuint help_texture_id = Utility::load_texture("assets/images/help-page.png");
    m_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL_DATA_HELPPAGE, help_texture_id, 1.0f, 16, 12);

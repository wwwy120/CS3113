...
unsigned int LEVEL_DATA_C_DECOR[] =
{
...
void LevelC::initialise()
{
    ...
    m_state.decoration = new Map(DECORATION_WIDTH, DECORATION_HEIGHT, LEVEL_DATA_C_DECOR, texture_id, 1.0f, 18, 14);
    m_state.map = new Map(DECORATION_WIDTH, DECORATION_HEIGHT, LEVEL_DATA_C_MAP, texture_id, 1.0f, 18, 14);
    ...
    for(int i = 0; i < ENEMY_COUNT; ++i){
        ...
        m_state.enemies[i].m_walking[ m_state.enemies[i].UP]    = new int[3] { 90, 91, 92 };
        m_state.enemies[i].m_walking[ m_state.enemies[i].DOWN]  = new int[3] { 54, 55, 56 };
...
//    m_state.enemies[0].set_position(glm::vec3(rand() % 16, rand() % 16, 0.0f));
//    m_state.enemies[1].set_position(glm::vec3(rand() % 16, rand() % 16, 0.0f));
//    m_state.enemies[2].set_position(glm::vec3(-rand() % 16, rand() % 16, 0.0f));
//    m_state.enemies[3].set_position(glm::vec3(-rand() % 16, rand() % 16, 0.0f));
//    m_state.enemies[4].set_position(glm::vec3(-rand() % 16, -rand() % 16, 0.0f));
//    m_state.enemies[5].set_position(glm::vec3(-rand() % 16, -rand() % 16, 0.0f));
//    m_state.enemies[6].set_position(glm::vec3(rand() % 16, -rand() % 16, 0.0f));
//    m_state.enemies[7].set_position(glm::vec3(rand() % 16, -rand() % 16, 0.0f));
//    m_state.enemies[8].set_position(glm::vec3(rand() % 16, -rand() % 16, 0.0f));
//    m_state.enemies[9].set_position(glm::vec3(-rand() % 16, rand() % 16, 0.0f));

...
enum EntityType { PLAYER, ENEMY, STAR, BOMB, MUD, BOMB_C, STAR_C};
...
public:
    ...
    bool m_is_active = true;       //AI & bomb
    bool alive = true;             //AI & player
    bool m_appear = false;         //star
    ...
    void disappear();
    bool check_collision(Entity* collidable_entities, int collidable_entity_count);
